...
@Stateless
@Path("/editarJuguete")
public class EditarJugueteImpl implements EditarJuguete {

    @GET
    @Produces(MediaType.TEXT_PLAIN)
    @Override
    public int Editarjuguete(@QueryParam("idinventario") int idInventario,
        ...
        Inventario_TO juguete = new Inventario_TO(idInventario, codigo, nombre, descripcion, edadDesde, edadHasta, genero, cantidad, url1, url2, url3, url4, url5, url6, url7, url8, url9, url10, url11, url12, observacion, new Empresa_TO(idEmpresa));
        JugueteDAO jugueteDao = new JugueteDAOImpl();
        return  jugueteDao.EditarJuguete(juguete);
    }
