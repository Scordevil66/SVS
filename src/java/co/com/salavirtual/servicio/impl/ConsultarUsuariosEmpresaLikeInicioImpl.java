 ...
 */
@Stateless
@Path("/consultarUsuariosEmpresaLikeInicio")
public class ConsultarUsuariosEmpresaLikeInicioImpl implements ConsultarUsuariosEmpresaLike{
    ...
    public List<Usuario_TO> consultarUsuariosEmpresaLike(@QueryParam("idEmpresa") int idEmpresa,@QueryParam("nombre") String nombre) throws Exception {
        ...
        return  usuarioDAO.consultarUsuariosEmpresaLikeInicio(idEmpresa,nombre );
    }
